...
st.markdown(
    """
    <style>
    .reportview-container, .css-18e3th9 { background-color: #000000; color: #FFFFFF; }
    .stButton>button { background-color: #FF7700; color: #000000; border: 2px solid #00FFCC; border-radius: 12px; padding: 0.5em 1.5em; font-size: 1.1em; font-weight: bold; box-shadow: 2px 2px 5px rgba(0,0,0,0.5); }
    .stButton>button:hover { background-color: #FF8A33; border-color: #00E6B8; }
    .css-1v3fvcr { background-color: #1A1A1A; color: #FF7700; }
    a { color: #00FFCC; }
    </style>
    """,
